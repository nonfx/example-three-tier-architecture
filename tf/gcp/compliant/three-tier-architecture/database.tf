...
resource "google_sql_database_instance" "main" {
  ...
  settings {
    ...
    # This setting ensures that all DDL statements are logged for security auditing purposes
    # as required by CIS Google Cloud Platform Foundation Benchmark v3.0.0 Section 6.2.4
    database_flags {
      name  = "log_statement"
      value = "ddl"
    }
